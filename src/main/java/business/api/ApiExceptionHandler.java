...
public class ApiExceptionHandler {
	...
	@ExceptionHandler({ NotFoundUserIdException.class, NotFoundTrainingIdException.class,
			NotFoundCourtIdException.class })
	@ResponseBody
	...
	@ExceptionHandler({ AlreadyExistUserFieldException.class, AlreadyExistUserFieldException.class,
			InvalidCourtReserveException.class })
	@ResponseBody
	...
	@ExceptionHandler({ PlayerNotExistInTrainingException.class, PlayerMaximumReachedException.class,
			PlayerAlreadyInTrainingException.class })
	@ResponseBody
