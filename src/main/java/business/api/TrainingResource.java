...
public class TrainingResource {
	...
	public TrainingAvailability showTrainingAvailability(@RequestParam(required = true) Calendar startDate,
			Calendar endDate) {
		return trainingController.showTrainings(startDate, endDate);
	}

	@RequestMapping(method = RequestMethod.POST)
	public String createTraining(@AuthenticationPrincipal User activeUser,
			@RequestBody TrainingAvailableTime availableTime) throws NotFoundCourtIdException, NotFoundUserIdException {
	...
	public String deleteTraining(@RequestParam(required = true) int trainingId) throws NotFoundTrainingIdException {
	...
	public String registerPlayerInTraining(@RequestParam(required = true) String playerName, int trainingId)
			throws NotFoundTrainingIdException, NotFoundUserIdException, PlayerMaximumReachedException,
			PlayerAlreadyInTrainingException {
